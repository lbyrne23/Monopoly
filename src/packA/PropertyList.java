...
public class PropertyList extends ArrayList<Property>{
	public PropertyList(){
		...
		add(new Property("King's Cross Station", "Kings", -1, 200, SITE_RENTS[3], 8, 25, false, -1, 5));
		...
		add(new Property("Electric Company", "Electric", -1, 150, SITE_RENTS[8], 9, 50, false, -1, 12)); 
		...
		add(new Property("Liverpool St Station","Liverpool", -1, 200, SITE_RENTS[26], 8, 200, false, 200, 35));
